...
export function CatInfoComponentSelectors(selector: string = ":scope") {
    return Object.freeze({
         ...
         */
        nameInput(): string {
            return `${selector} [data-test="edit-name"]  input`;
        },
         ...
         */
        ageInput(): string {
            return `${selector} [data-test="edit-age"] input`;
        },
         ...
         */
        breedInput(): string {
            return `${selector} [data-test="edit-breed"] input`;
        },
         ...
         */
        colorInput(): string {
            return `${selector} [data-test="edit-color"] input`;
        },
        ...
        favoriteFoodInput(): string {
            return `${selector} [data-test="edit-favorite-food"] input`;
        },
    });
}
