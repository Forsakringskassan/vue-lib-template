...
The corresponding example is [`CatInfoExample.vue`](https://github.com/Forsakringskassan/vue-lib-template/blob/main/src/examples/CatInfoExample.vue). Keep the example focused on a realistic use case and make its initial state useful without extra setup.
...
The reference implementation shows this pattern in [FcCatInfoComponentLiveExample.vue](https://github.com/Forsakringskassan/vue-lib-template/blob/main/src/FcCatInfoComponentLiveExample.vue) and its [documentation page](https://github.com/Forsakringskassan/vue-lib-template/blob/main/docs/kattinformation/index.md).
