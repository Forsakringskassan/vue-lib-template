...
The cat information logic is tested in [`cat-info-logic.spec.ts`](https://github.com/Forsakringskassan/vue-lib-template/blob/main/src/cat-info-logic.spec.ts). It mocks the API module and verifies loading, successful data, errors, and updates:
...
The local example is [`cat-api.mock.mts`](https://github.com/Forsakringskassan/vue-lib-template/blob/main/src/cat-api.mock.mts):
...
3. Import it in [`src/mocks.mts`](https://github.com/Forsakringskassan/vue-lib-template/blob/main/src/mocks.mts).
...
Use Cypress for user-visible component behavior: rendering, loading states, form interaction, emitted actions, error states, and accessibility-related behavior. The current example is [`FcCatInfoComponent.cy.ts`](https://github.com/Forsakringskassan/vue-lib-template/blob/main/src/FcCatInfoComponent.cy.ts).
...
Keep reusable selectors in a `selectors/` file instead of scattering CSS selectors through specs. The [`FcCatInfoComponent` selector helper](https://github.com/Forsakringskassan/vue-lib-template/blob/main/src/selectors/FcCatInfoComponent.selectors.ts) uses [`data-test`](https://designsystem.forsakringskassan.se/latest/functions/plugins/testplugin.html) attributes and supports scoping a component instance.
